...
def weighted_masked_mse(
    ...
    y_hat, y: [B,T]
    m: [B,T] mask in {0,1}
    w: [B,T] weight in [0,1] (e.g., reliability C)
    """
    diff2 = (y_hat - y) ** 2
...
def main():
    ...
    out_dir = os.path.join(paths.processed_dir, "checkpoints_physics_weightedC")
    ensure_dir(out_dir)
    ...
    for epoch in range(1, 51):
        ...
        for batch in train_loader:
            ...
            # supervision loss (AI)
            L_sup = weighted_masked_mse(y_hat, y, mc, w=cc)
